...
export function HeroSection({ setIsModalFormOpen }) {
  return (
    <section
      ...
      className="relative mb-8 flex h-72 w-full items-center justify-center bg-cover bg-center bg-no-repeat shadow-md before:absolute before:inset-0 before:bg-black/75 md:h-80 lg:h-96 lg:bg-[position:0_40%] xl:h-[448px]"
    >
