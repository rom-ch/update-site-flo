    ...
    <section id="ma-pratique" className="my-12 space-y-6 overflow-hidden">
      ...
      <div className="flex flex-col gap-8">
        <div className="bg-gray-200 pt-0 pb-6 md:py-6 xl:flex">
          <div className="space-y-4 md:mx-auto md:space-y-0">
            <div className="clip-left md:clip-md-left h-60 w-full sm:h-72 md:float-left md:h-[400px] md:w-96 lg:h-full lg:w-2xl">
              <img
        ...
        <div className="pt-0 pb-6 md:py-6 xl:flex">
