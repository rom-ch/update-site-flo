  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="safe-padding animate-slide-down-fade-in absolute top-1/2 h-fit max-h-[90dvh] w-[90%] max-w-[400px] -translate-y-1/2 overflow-y-auto rounded-xl bg-zinc-50 p-6 sm:mx-10 sm:max-w-xl"
      >
        <button
          onClick={onClose}
